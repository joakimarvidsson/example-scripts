...
def _base_specs() -> list[MultitaskSpec]:
    ...
    return [
        ...
        MultitaskSpec(
            name="mtmlp_strict_resid010_medmask40b_faith96_mainonly_walkfwd",
            main_target_mix=None,
            feature_set="medium_mask40b+faith2:96",
            residual_scale=0.010,
            aux_target_col=None,
            aux_weight=0.0,
            **common_no_resid_or_feat,
        ...
        MultitaskSpec(
            name="mtmlp_strict_resid010_medmask40b_faith128_mainonly_walkfwd",
            main_target_mix=None,
            feature_set="medium_mask40b+faith2:128",
            residual_scale=0.010,
            aux_target_col=None,
            aux_weight=0.0,
            **common_no_resid_or_feat,
        ...
        MultitaskSpec(
            name="mtmlp_strict_resid010_medmask35b_faith64_mainonly_walkfwd",
            main_target_mix=None,
            feature_set="medium_mask35b+faith2:64",
            residual_scale=0.010,
            aux_target_col=None,
            aux_weight=0.0,
            **common_no_resid_or_feat,
        ...
        MultitaskSpec(
            name="mtmlp_strict_resid010_medmask45b_faith64_mainonly_walkfwd",
            main_target_mix=None,
            feature_set="medium_mask45b+faith2:64",
            residual_scale=0.010,
            aux_target_col=None,
            aux_weight=0.0,
            **common_no_resid_or_feat,
        ...
        MultitaskSpec(
            name="mtmlp_strict_resid010_medmask40c_faith64_mainonly_walkfwd",
            main_target_mix=None,
            feature_set="medium_mask40c+faith2:64",
            residual_scale=0.010,
            aux_target_col=None,
            aux_weight=0.0,
            **common_no_resid_or_feat,
...
def _build_custom_feature_subspaces(
    ...
    return dict(
        [
            ...
            sample_medium("medium_mask35b", 0.35, 20260342),
            sample_medium("medium_mask40a", 0.40, 20260341),
            sample_medium("medium_mask40b", 0.40, 20260342),
            sample_medium("medium_mask40c", 0.40, 20260343),
            sample_medium("medium_mask45b", 0.45, 20260342),
