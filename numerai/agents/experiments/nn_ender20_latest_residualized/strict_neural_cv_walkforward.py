...
def _initial_specs() -> list[NeuralCvSpec]:
    return [
        ...
        NeuralCvSpec(
            name="ncv_gated_resid008_medfaith64_hl256",
            feature_set="medium:256+faith2:64",
        ...
        NeuralCvSpec(
            name="ncv_gated_resid010_medfaith64_nodecay",
            feature_set="medium:256+faith2:64",
            residual_scale=0.010,
            hidden_layer_sizes=(768, 384, 192),
            dropout=0.10,
        ...
        NeuralCvSpec(
            name="ncv_gated_resid010_medfaith64_hl128",
            feature_set="medium:256+faith2:64",
            residual_scale=0.010,
            hidden_layer_sizes=(768, 384, 192),
            dropout=0.10,
        ...
        NeuralCvSpec(
            name="ncv_gated_resid010_medfaith64_hl512",
            feature_set="medium:256+faith2:64",
            residual_scale=0.010,
            hidden_layer_sizes=(768, 384, 192),
            dropout=0.10,
            ...
            clip_grad_norm=1.0,
            arch_type="gated",
            era_decay_halflife=512.0,
        ),
        NeuralCvSpec(
            name="ncv_gated_resid012_medfaith64_hl256",
            feature_set="medium:256+faith2:64",
        ...
        NeuralCvSpec(
            name="ncv_gated_resid010_medfaith64_nodecay_auxe60w025",
            feature_set="medium:256+faith2:64",
            residual_scale=0.010,
            hidden_layer_sizes=(768, 384, 192),
            dropout=0.10,
        ...
        NeuralCvSpec(
            name="ncv_gated_resid010_medfaith64_nodecay_auxt60w025",
            feature_set="medium:256+faith2:64",
            residual_scale=0.010,
            hidden_layer_sizes=(768, 384, 192),
            dropout=0.10,
        ...
        NeuralCvSpec(
            name="ncv_twotower_resid008_medfaith64_hl256",
            feature_set="medium:256+faith2:64",
            residual_scale=0.008,
        ...
        NeuralCvSpec(
            name="ncv_twotower_resid010_medfaith64_nodecay",
            feature_set="medium:256+faith2:64",
            residual_scale=0.010,
            hidden_layer_sizes=(512, 256, 128),
            dropout=0.10,
        ...
        NeuralCvSpec(
            name="ncv_twotower_resid010_medfaith128_hl128_auxe60w025",
        ...
        NeuralCvSpec(
            name="ncv_twotower_resid010_medfaith128_hl128_auxt60w025",
            feature_set="medium:192+faith2:128",
            residual_scale=0.010,
            hidden_layer_sizes=(512, 256, 128),
            dropout=0.10,
        ...
        NeuralCvSpec(
            name="ncv_twotower_resid012_medfaith128_hl128",
            feature_set="medium:192+faith2:128",
            residual_scale=0.012,
            hidden_layer_sizes=(512, 256, 128),
            dropout=0.10,
